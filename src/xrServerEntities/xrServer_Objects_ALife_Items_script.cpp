...
SCRIPT_EXPORT(CSE_ALifeItem, (CSE_ALifeDynamicObjectVisual, CSE_ALifeInventoryItem), {
    module(luaState)[luabind_class_item2(
...
SCRIPT_EXPORT(CSE_ALifeItemTorch, (CSE_ALifeItem),
    { module(luaState)[luabind_class_item1(CSE_ALifeItemTorch, "cse_alife_item_torch", CSE_ALifeItem)]; });

SCRIPT_EXPORT(CSE_ALifeItemAmmo, (CSE_ALifeItem),
    { module(luaState)[luabind_class_item1(CSE_ALifeItemAmmo, "cse_alife_item_ammo", CSE_ALifeItem)]; });

SCRIPT_EXPORT(CSE_ALifeItemWeapon, (CSE_ALifeItem), {
    module(luaState)[luabind_class_item1(CSE_ALifeItemWeapon, "cse_alife_item_weapon",
        CSE_ALifeItem).def("clone_addons", &CSE_ALifeItemWeapon::clone_addons)];
});
...
SCRIPT_EXPORT(CSE_ALifeItemDetector, (CSE_ALifeItem),
    { module(luaState)[luabind_class_item1(CSE_ALifeItemDetector, "cse_alife_item_detector", CSE_ALifeItem)]; });
