...
#define CLSID_SE_OUTFIT MK_CLSID('E', '_', 'S', 'T', 'L', 'K', ' ', ' ')
#define CLSID_SE_GRENADE_F1 MK_CLSID('G', '_', 'F', '1', '_', 'S', ' ', ' ')
...
#define CLSID_SE_SMART_TERRAIN MK_CLSID('S', 'M', 'R', 'T', 'T', 'R', 'R', 'N')
#define CLSID_SE_SMART_COVER MK_CLSID('S', 'M', 'R', 'T', '_', 'C', '_', 'S')
#define CLSID_SE_MONSTER_BLOODSUCKER MK_CLSID('S', 'M', '_', 'B', 'L', 'O', 'O', 'D')
#define CLSID_SE_MONSTER_BOAR MK_CLSID('S', 'M', '_', 'B', 'O', 'A', 'R', 'W')
#define CLSID_SE_MONSTER_BURER MK_CLSID('S', 'M', '_', 'B', 'U', 'R', 'E', 'R')
#define CLSID_SE_MONSTER_CAT MK_CLSID('S', 'M', '_', 'C', 'A', 'T', '_', 'S')
#define CLSID_SE_MONSTER_CHIMERA MK_CLSID('S', 'M', '_', 'C', 'H', 'I', 'M', 'S')
#define CLSID_SE_MONSTER_CONTROLLER MK_CLSID('S', 'M', '_', 'C', 'O', 'N', 'T', 'R')
#define CLSID_SE_MONSTER_DOG_PSY_PHANTOM MK_CLSID('S', 'M', '_', 'D', 'O', 'G', '_', 'F')
#define CLSID_SE_MONSTER_DOG_PSY MK_CLSID('S', 'M', '_', 'D', 'O', 'G', '_', 'P')
#define CLSID_SE_MONSTER_DOG MK_CLSID('S', 'M', '_', 'D', 'O', 'G', '_', 'S')
#define CLSID_SE_MONSTER_FLESH MK_CLSID('S', 'M', '_', 'F', 'L', 'E', 'S', 'H')
#define CLSID_SE_MONSTER_PSEUDO_GIGANT MK_CLSID('S', 'M', '_', 'G', 'I', 'A', 'N', 'T')
#define CLSID_SE_MONSTER_IZLOM MK_CLSID('S', 'M', '_', 'I', 'Z', 'L', 'O', 'M')
#define CLSID_SE_MONSTER_POLTERGEIST MK_CLSID('S', 'M', '_', 'P', 'O', 'L', 'T', 'R')
#define CLSID_SE_MONSTER_DOG_PSEUDO MK_CLSID('S', 'M', '_', 'P', '_', 'D', 'O', 'G')
#define CLSID_SE_MONSTER_SNORK MK_CLSID('S', 'M', '_', 'S', 'N', 'O', 'R', 'K')
#define CLSID_SE_MONSTER_TUSHKANO MK_CLSID('S', 'M', '_', 'T', 'U', 'S', 'H', 'K')
#define CLSID_SE_MONSTER_ZOMBI MK_CLSID('S', 'M', '_', 'Z', 'O', 'M', 'B', 'I')
#define CLSID_SE_LAMP MK_CLSID('S', 'O', '_', 'H', 'L', 'A', 'M', 'P')
#define CLSID_SE_RESTRICTOR MK_CLSID('S', 'P', 'C', '_', 'R', 'S', '_', 'S')
#define CLSID_SE_ACTOR MK_CLSID('S', '_', 'A', 'C', 'T', 'O', 'R', ' ')
#define CLSID_SE_ANTIRAD MK_CLSID('S', '_', 'A', 'N', 'T', 'I', 'R', ' ')
#define CLSID_SE_BANDAGE MK_CLSID('S', '_', 'B', 'A', 'N', 'D', 'G', ' ')
#define CLSID_SE_BOTTLE MK_CLSID('S', '_', 'B', 'O', 'T', 'T', 'L', ' ') // @ Lord: где это использукется
#define CLSID_SE_EXPLOSION MK_CLSID('S', '_', 'E', 'X', 'P', 'L', 'O', ' ')
#define CLSID_SE_FOOD MK_CLSID('S', '_', 'F', 'O', 'O', 'D', ' ', ' ')
#define CLSID_SE_INVENTORY_BOX MK_CLSID('S', '_', 'I', 'N', 'V', 'B', 'O', 'X')
#define CLSID_SE_M209 MK_CLSID('S', '_', 'M', '2', '0', '9', ' ', ' ')
#define CLSID_SE_MEDKIT MK_CLSID('S', '_', 'M', 'E', 'D', 'K', 'I', ' ')
#define CLSID_SE_OG78B MK_CLSID('S', '_', 'O', 'G', '7', 'B', ' ', ' ')
#define CLSID_SE_PDA MK_CLSID('S', '_', 'P', 'D', 'A', ' ', ' ', ' ')
#define CLSID_SE_VOG25 MK_CLSID('S', '_', 'V', 'O', 'G', '2', '5', ' ')
#define CLSID_SE_TORCH MK_CLSID('T', 'O', 'R', 'C', 'H', '_', 'S', ' ')
#define CLSID_SE_WEAPON_AK74 MK_CLSID('W', 'P', '_', 'A', 'K', '7', '4', ' ')
#define CLSID_SE_WEAPON_SHOTGUN_AUTOMATIC MK_CLSID('W', 'P', '_', 'A', 'S', 'H', 'T', 'G')
#define CLSID_SE_WEAPON_BINOCULAR MK_CLSID('W', 'P', '_', 'B', 'I', 'N', 'O', 'C')
#define CLSID_SE_WEAPON_BM16 MK_CLSID('W', 'P', '_', 'B', 'M', '1', '6', ' ')
#define CLSID_SE_WEAPON_GRENADE_LAUNCHER MK_CLSID('W', 'P', '_', 'G', 'L', 'A', 'U', 'N')
...
#define CLSID_SE_WEAPON_SCOPE MK_CLSID('W', 'P', '_', 'S', 'C', 'O', 'P', 'E')
#define CLSID_SE_WEAPON_SHOTGUN MK_CLSID('W', 'P', '_', 'S', 'H', 'O', 'T', 'G')
#define CLSID_SE_WEAPON_SILENCER MK_CLSID('W', 'P', '_', 'S', 'I', 'L', 'E', 'N')
#define CLSID_SE_WEAPON_SVD MK_CLSID('W', 'P', '_', 'S', 'V', 'D', ' ', ' ')
#define CLSID_SE_WEAPON_SVU MK_CLSID('W', 'P', '_', 'S', 'V', 'U', ' ', ' ')
#define CLSID_SE_WEAPON_USP45 MK_CLSID('W', 'P', '_', 'U', 'S', 'P', '4', '5')
#define CLSID_SE_WEAPON_VAL MK_CLSID('W', 'P', '_', 'V', 'A', 'L', ' ', ' ')
#define CLSID_SE_WEAPON_VINTOREZ MK_CLSID('W', 'P', '_', 'V', 'I', 'N', 'T', ' ')
#define CLSID_SE_WEAPON_WALTHER MK_CLSID('W', 'P', '_', 'W', 'A', 'L', 'T', 'H')
#define CLSID_SE_ZONE_HAIRS MK_CLSID('Z', 'S', '_', 'B', 'F', 'U', 'Z', 'Z')
#define CLSID_SE_ZONE_GALANT MK_CLSID('Z', 'S', '_', 'G', 'A', 'L', 'A', 'N')
#define CLSID_SE_ZONE_MOSQUITOBALD MK_CLSID('Z', 'S', '_', 'M', 'B', 'A', 'L', 'D')
