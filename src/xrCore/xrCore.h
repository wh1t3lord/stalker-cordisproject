...
#define MESSAGEI(text_message, ...) { xr_string file_name = __FILE__; Msg("[%s|" __FUNCTION__ "|%d] information -> "##text_message, file_name.substr(file_name.rfind("\\")).c_str(), __LINE__, __VA_ARGS__); }
