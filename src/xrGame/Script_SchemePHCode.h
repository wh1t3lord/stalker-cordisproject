...
public:
    ...
    Script_SchemePHCode(CScriptGameObject* const p_client_object, DataBase::Script_ComponentScheme_PHCode* storage);
        ...
        const xr_string& scheme_name, const xr_string& section_name, DataBase::Script_IComponentScheme* storage)
    {
        ...
        Script_ISchemeEntity* p_scheme = new Script_SchemePHCode(p_client_object, reinterpret_cast<DataBase::Script_ComponentScheme_PHCode*>(storage));
...
private:
    DataBase::Script_ComponentScheme_PHCode* m_p_storage;
};
