...
namespace Scripts
{
Script_SE_Lamp::Script_SE_Lamp(LPCSTR section_name) : inherited(section_name), m_is_secret_item(false) { Msg("[Scripts/Script_SE_Lamp/ctor(section_name)] %s", section_name); }
