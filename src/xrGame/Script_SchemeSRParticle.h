...
public:
    ...
    Script_SchemeSRParticle(CScriptGameObject* const p_client_object, DataBase::Script_ComponentScheme_SRParticle* storage);
        ...
        const xr_string& scheme_name, const xr_string& section_name, DataBase::Script_IComponentScheme* storage)
    {
        ...
        Script_ISchemeEntity* p_scheme = new Script_SchemeSRParticle(p_client_object, reinterpret_cast<DataBase::Script_ComponentScheme_SRParticle*>(storage));
...
private:
    ...
    DataBase::Script_ComponentScheme_SRParticle* m_p_storage;
