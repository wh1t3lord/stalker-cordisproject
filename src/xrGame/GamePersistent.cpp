...
void CGamePersistent::OnFrame()
{
    ...
    if (Cordis::Scripts::Script_GlobalHelper::getInstance().getGlobalTutorial() && !Cordis::Scripts::Script_GlobalHelper::getInstance().getGlobalTutorial()->IsActive())
    {
        Cordis::Scripts::Script_GlobalHelper::getInstance().getGlobalTutorial()->Destroy();
