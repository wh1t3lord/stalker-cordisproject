...
void CBaseMonster::add_debug_info(debug::text_tree& root_s)
{
    ...
    detail_debug::add_debug_info(general_s, this);
    ...
    if (SoundMemory.IsRememberSound())
    {
        ...
        detail_debug::add_debug_info(last_s, last_sound, last_dangerous);
        ...
        if (SoundMemory.GetNumSounds() > 1)
        {
            ...
            detail_debug::add_debug_info(first_s, first_sound, first_dangerous);
        }
    }
    else
    {
    ...
    if (HitMemory.is_hit())
    {
        ...
        detail_debug::add_debug_info(last_hit_object_s, smart_cast<CEntity*>(HitMemory.get_last_hit_object()));
    ...
    if (squad)
    {
        ...
        detail_debug::add_debug_info(squad_s.add_line("Leader"), squad->GetLeader());
        ...
        detail_debug::add_debug_info(squad_goal_s.add_line("Goal_Entity"), squad->GetGoal(this).entity);
    }
    ...
    else
    {
        ...
        {
            detail_debug::add_debug_info(cur_script_action_s, m_tpCurrentEntityAction);
        }
        else
        {
        ...
        {
            detail_debug::add_debug_info(next_script_action_s, m_tpActionQueue.front());
        }
        else
        {
    ...
    if (EnemyMan.get_enemy())
    {
        detail_debug::add_enemy_debug_info(current_enemy_s, this, EnemyMan.get_enemy());
         ...
         ++i)
    {
        ...
        if (p_enemy != EnemyMan.get_enemy())
        {
            ...
            detail_debug::add_enemy_debug_info(enemy_s, this, p_enemy);
        }
    }
    ...
    if (p_blend)
    {
        detail_debug::add_debug_info(current_animation_s, p_blend);
    ...
    detail_debug::add_debug_info(movement_s.add_line("Orientation_Current"), movement().body_orientation().current);
    detail_debug::add_debug_info(movement_s.add_line("Orientation_Target"), movement().body_orientation().target);
    ...
    {
        detail_debug::add_debug_info_restrictions(
