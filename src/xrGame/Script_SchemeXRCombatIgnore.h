...
namespace Cordis
{
	namespace Scripts
	{
		...
		public:
			...
			Script_SchemeXRCombatIgnore(CScriptGameObject* const p_client_object, DataBase::Script_ComponentScheme_XRCombatIgnore* storage);
			...
			static bool is_enemy_xr_combat_ignore(CScriptGameObject* const p_client_object, CScriptGameObject* const p_enemy, DataBase::Script_ComponentScheme_XRCombatIgnore* p_storage);
		...
		private:
			DataBase::Script_ComponentScheme_XRCombatIgnore* m_p_storage;
		};
	}
}
