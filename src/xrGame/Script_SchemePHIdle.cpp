...
namespace Scripts
{
Script_SchemePHIdle::Script_SchemePHIdle(CScriptGameObject* const p_client_object, void* storage)
...
void Script_SchemePHIdle::reset_scheme(const bool value, CScriptGameObject* const p_client_object)
{
    ...
    this->m_npc->SetNonscriptUsable(this->m_p_storage->IsPHIdleNonScriptUsable());
}
