...
struct __declspec(dllexport) SInputSignature : public xr_resource_flagged
{
    ID3DBlob* signature;
...
#endif //	USE_DX10
//////////////////////////////////////////////////////////////////////////
struct __declspec(dllexport) SVS : public xr_resource_named
{
#ifdef USE_OGL
    GLuint sh;
#else
...
//////////////////////////////////////////////////////////////////////////
struct __declspec(dllexport) SPS : public xr_resource_named
{
#ifdef USE_OGL
    GLuint sh;
#else
...
#ifndef USE_DX9
//////////////////////////////////////////////////////////////////////////
struct __declspec(dllexport) SGS : public xr_resource_named
{
#ifdef USE_OGL
    GLuint sh;
#else
...
struct __declspec(dllexport) SHS : public xr_resource_named
{
#ifdef USE_OGL
    GLuint sh;
#else
...
struct __declspec(dllexport) SDS : public xr_resource_named
{
#ifdef USE_OGL
    GLuint sh;
#else
...
struct __declspec(dllexport) SCS : public xr_resource_named
{
#ifdef USE_OGL
    GLuint sh;
#else
...
//////////////////////////////////////////////////////////////////////////
struct __declspec(dllexport) SState : public xr_resource_flagged
{
#ifdef	USE_OGL
    glState state;
#else
...
//////////////////////////////////////////////////////////////////////////
struct __declspec(dllexport) SDeclaration : public xr_resource_flagged
{
#if defined(USE_OGL)
    u32 FVF;
    GLuint dcl;
