...
//////////////////////////////////////////////////////////////////////////
struct __declspec(dllexport) STextureList : public xr_resource_flagged, public xr_vector<std::pair<u32, ref_texture>>
{
...
//////////////////////////////////////////////////////////////////////////
struct __declspec(dllexport) SMatrixList : public xr_resource_flagged, public svector<ref_matrix, 4>
{
    ~SMatrixList();
};
typedef resptr_core<SMatrixList, resptr_base<SMatrixList>> ref_matrix_list;
//////////////////////////////////////////////////////////////////////////
struct __declspec(dllexport) SConstantList : public xr_resource_flagged, public svector<ref_constant_obsolette, 4>
{
    ~SConstantList();
};
...
//////////////////////////////////////////////////////////////////////////
struct __declspec(dllexport) SGeometry : public xr_resource_flagged
{
    ref_declaration dcl;
#ifdef USE_OGL
	GLuint vb;
...
struct __declspec(dllexport) resptrcode_geom : public resptr_base<SGeometry>
{
#ifdef USE_OGL
...
//////////////////////////////////////////////////////////////////////////
struct __declspec(dllexport) SPass : public xr_resource_flagged
{
...
//////////////////////////////////////////////////////////////////////////
struct __declspec(dllexport) ShaderElement : public xr_resource_flagged
{
    struct Sflags
    {
        u32 iPriority : 2;
...
//////////////////////////////////////////////////////////////////////////
struct __declspec(dllexport) Shader : public xr_resource_flagged
{
...
struct __declspec(dllexport) resptrcode_shader : public resptr_base<Shader>
{
