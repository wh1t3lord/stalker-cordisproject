...
class __declspec(dllexport) R_constant_setup;
...
struct __declspec(dllexport) R_constant_load
{
...
struct __declspec(dllexport) R_constant : public xr_resource
{
...
class __declspec(dllexport) R_constant_table : public xr_resource_flagged
{
public:
