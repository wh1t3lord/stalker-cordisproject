...
/*
#ifndef __declspec(dllexport)
#pragma message("__declspec(dllexport) not defined. Invoking ugly hack to enable compilation.")
...
class __declspec(dllexport) CDUInterface
{
public:
    //----------------------------------------------------
    ...
    virtual void  DrawIdentSphere(const Fmatrix&, bool) = 0;
    ...
    virtual void  DrawIdentBox(const Fmatrix&, bool) = 0;
