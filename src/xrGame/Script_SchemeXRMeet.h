...
namespace Cordis
{
	namespace Scripts
	{
		...
		public:
			...
			static void init_meet(CScriptGameObject* const p_client_object, CScriptIniFile* const p_ini, const xr_string& section_name, DataBase::Storage_Scheme& storage, const xr_string& scheme_name);
