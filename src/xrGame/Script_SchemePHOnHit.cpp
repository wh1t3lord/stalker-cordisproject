...
namespace Scripts
{
Script_SchemePHOnHit::Script_SchemePHOnHit(CScriptGameObject* const p_client_object, void* storage)
    ...
    const xr_string& scheme_name, const xr_string& section_name, const xr_string& gulag_name)
{
    ...
    if (!p_ini)
    {
        Msg("[Scripts/Script_SchemePHOnHit/set_scheme(p_client_object, p_ini, scheme_name, section_name, gulag_name)] "
            "WARNING: p_ini == nullptr!");
    }
