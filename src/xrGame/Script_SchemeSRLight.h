...
public:
    ...
    Script_SchemeSRLight(CScriptGameObject* const p_client_object, DataBase::Script_ComponentScheme_SRLight* storage);
        ...
        const xr_string& scheme_name, const xr_string& section_name, DataBase::Script_IComponentScheme* storage)
    {
        ...
        Script_ISchemeEntity* p_scheme = new Script_SchemeSRLight(p_client_object, reinterpret_cast<DataBase::Script_ComponentScheme_SRLight*>(storage));
...
private:
    bool m_is_active;
    DataBase::Script_ComponentScheme_SRLight* m_p_storage;
};
} // namespace Scripts
} // namespace Cordis
