...
public:
    ...
    Script_SchemePHIdle(CScriptGameObject* const p_client_object, DataBase::Storage_Scheme& storage);
        ...
        const xr_string& scheme_name, const xr_string& section_name, DataBase::Storage_Scheme& storage)
    {
        ...
        Script_ISchemeEntity* p_scheme = new Script_SchemePHIdle(p_client_object, storage);
