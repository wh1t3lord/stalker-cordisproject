...
public:
    ...
    static inline void add_to_binder(CScriptGameObject* const p_client_object, CScriptIniFile* const p_ini,
        const xr_string& scheme_name, const xr_string& section_name, DataBase::Script_ComponentScheme_PHOscillate* storage)
    {
        if (!p_client_object)
        {
        ...
        Script_ISchemeEntity* p_scheme = new Script_SchemePHOscillate(p_client_object, reinterpret_cast<DataBase::Script_ComponentScheme_PHOscillate*>(storage));
