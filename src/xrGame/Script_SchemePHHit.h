...
public:
    ...
    Script_SchemePHHit(CScriptGameObject* const p_client_object, DataBase::Storage_Scheme& storage);
        ...
        const xr_string& scheme_name, const xr_string& section_name, DataBase::Storage_Scheme& storage)
    {
        ...
        Script_ISchemeEntity* p_scheme = new Script_SchemePHHit(p_client_object, storage);
