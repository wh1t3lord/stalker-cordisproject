...
namespace Scripts
{
Script_SE_Outfit::Script_SE_Outfit(LPCSTR section_name) : inherited(section_name), m_is_secret_item(false) { Msg("[Scripts/Script_SE_Outfit/ctor(section_name)] %s", section_name); }
