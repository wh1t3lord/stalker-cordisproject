...
void D3DXRenderBase::DestroyHW()
{
    ...
    DeviceState D3DXRenderBase::GetDeviceState()
    {
        ...
        case D3DERR_DEVICELOST: return DeviceState::Lost;

        // Check if the device is ready to be reset
        case D3DERR_DEVICENOTRESET: return DeviceState::NeedReset;
        }
#endif
...
#ifdef DEBUG
        font.OutNext(
            "SH/T/M/C:     %d/%d/%d/%d", rcstats.states, rcstats.textures, rcstats.matrices, rcstats.constants);
