...
static LPCSTR ZBname_main = "$user$main_zb";
static LPCSTR ZBname_temp = "$user$temp_zb";
...
BOOL CRenderTarget::Create()
{
    ...
    {
        ZB.create(ZBname_main, rtWidth, rtHeight, HW.Caps.fDepth);
    }
    else
    {
        ZB._set(new CRT());
    ...
    pTempZB.create(ZBname_temp, 512, 512, HW.Caps.fDepth);
