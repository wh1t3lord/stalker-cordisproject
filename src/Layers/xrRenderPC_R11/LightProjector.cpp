...
void CLightProjector::calculate()
{
    ...
    RCache.set_ZB(RImplementation.Target->pTempZB->pZRT);
    HW.pContext->ClearDepthStencilView(RImplementation.Target->pTempZB->pZRT, D3D_CLEAR_DEPTH | D3D_CLEAR_STENCIL, 1.0f, 0);
