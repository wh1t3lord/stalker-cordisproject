...
{
private:
    SDKUI_SceneOptions(void) noexcept
        : m_is_visible(false), m_hemisphere_quality(3), m_sun_shadow_quality(3), m_pixel_per_meter(10.0f),
          m_light_map_collapsing(4), m_light_map_zero(4), m_jitter_samples(2), m_normal_smooth_angle(75.0f),
          m_weld_distance(0.0050f), m_level_prefix("level"), m_flag(ImGuiWindowFlags_AlwaysAutoResize)
    {
    }
...
public:
    ...
    inline int getHemisphereQuality(void) noexcept { return this->m_hemisphere_quality; }
    inline int getSunShadowQuality(void) noexcept { return this->m_sun_shadow_quality; }
    inline int getLightMapCollapsing(void) noexcept { return this->m_light_map_collapsing; }
    inline int getLightMapZero(void) noexcept { return this->m_light_map_zero; }
    inline int getNormalSmoothAngle(void) noexcept { return this->m_normal_smooth_angle; }
    inline float getWeldDistance(void) noexcept { return this->m_weld_distance; }
    inline float getPixelPerMeter(void) noexcept { return this->m_pixel_per_meter; }
    inline char* getLevelPrefix(void) noexcept { return this->m_level_prefix; }
